...
\begin{enumerate}
    ...
    \item a controlled negative ablation showing a lower seed-and-view-averaged Loop206 robust Dice on the train screen, with per-seed directions mixed---one slightly positive and two negative; and
