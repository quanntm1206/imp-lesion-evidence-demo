...
\begin{enumerate}
    ...
    \item a controlled negative ablation showing a lower seed-and-view-averaged Loop206 robust Dice on the train screen; per-seed directions are unavailable in the authorized paper evidence; and
